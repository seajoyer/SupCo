* Homework Lagrange interpolation

The project provides C++ and Python implementations of Lagrange interpolation as shared libraries. There are plotting modules as well. Interpolation nodes may be distributed equidistantly or as Chebyshev nodes.
