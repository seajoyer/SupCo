...
*** 7. [[https://github.com/seajoyer/Boundary problem][Boundary Problem]]

A numerical solver for boundary value problems (BVPs) of second-order ordinary differential equations using the finite difference method.
